...
from infer_google_vision_landmark_detection.infer_google_vision_landmark_detection_process import InferGoogleVisionLandmarkDetectionParam
...
# --------------------
class InferGoogleVisionLandmarkDetectionWidget(core.CWorkflowTaskWidget):

    def __init__(self, param, parent):
        core.CWorkflowTaskWidget.__init__(self, parent)

        if param is None:
            self.parameters = InferGoogleVisionLandmarkDetectionParam()
        else:
...
# --------------------
class InferGoogleVisionLandmarkDetectionWidgetFactory(dataprocess.CWidgetFactory):

    def __init__(self):
        dataprocess.CWidgetFactory.__init__(self)
        # Set the algorithm name attribute -> it must be the same as the one declared in the algorithm factory class
        self.name = "infer_google_vision_landmark_detection"

    def create(self, param):
        # Create widget object
        return InferGoogleVisionLandmarkDetectionWidget(param, None)
